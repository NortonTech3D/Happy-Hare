...
#
# Some CANbus boards are prone to this but it have been seen on regular USB boards where a comms timeout or
# timer too close error will kill the print. Since it seems to occur only on homing moves they can be safely 
